...
impl RenderProgress {
    ...
    pub fn reset(&mut self) { self.accumulated_samples_per_pixel = 0_u32; }

    pub fn accumulated_samples(&self) -> u32 { self.accumulated_samples_per_pixel }
}
...
impl GpuCamera {
    ...
    pub fn make_ray(&mut self, u : f32, v : f32) -> Ray {
...
pub fn texture_lookup(desc : TextureDescriptor, textures : &[[f32; 3]], u : f32, v : f32) -> Vec3 {
...
impl Sphere {
    pub fn material_idx(&self) -> u32 { return self.2; }
}

impl Sphere {
    pub fn closest_hit_2<'a>(
        &'a self,
        ray : &Ray,
        tmin : f32,
        tmax : f32,
...
impl Sphere {
    fn ray_hit_info(&self, ray : &Ray, t : f32, hit : &mut Intersection) -> bool {
        ...
        let mut n = (1.0 / sphere.1) * (p - sphere.0.xyz());
...
pub trait Scatterable {
    fn scatter(&mut self, rec : &Intersection) -> (Vec3, Ray);
